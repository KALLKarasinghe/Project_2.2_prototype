...
const MyOrders = () => {
  ...
  // determine what to display based on login and order status
          ...
          <div key={order.id} className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 hover:shadow-md transition-shadow">
            ...
            <div className="mt-4 pt-4 border-t border-slate-100 flex justify-end gap-3 flex-wrap">
              <button
                ...
                className="text-indigo-600 hover:text-indigo-700 bg-indigo-50 hover:bg-indigo-100 px-4 py-2 rounded-xl font-bold text-sm transition-colors flex items-center gap-2"
              >
