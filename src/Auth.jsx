    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md relative z-10 my-8">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center justify-center mb-4 transition-transform hover:scale-105">
            <img src="/logo.png" alt="Global Medicine Logo" className="w-24 h-24 object-contain drop-shadow-lg" />
          </Link>
