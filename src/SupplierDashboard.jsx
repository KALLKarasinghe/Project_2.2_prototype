          ...
          <header className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            {activeTab === 'inventory' && (
              currentUser?.admin_approved == 0 ? (
                <div className="bg-amber-50 text-amber-800 border border-amber-200 px-4 py-2 rounded-xl text-sm font-semibold flex items-center gap-2">
                  <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
                  Your account is pending admin approval for adding medicines.
                </div>
              ) : (
